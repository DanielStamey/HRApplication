namespace EmployeeManager.Migrations
{
    ...
    public partial class Initial6 : DbMigration
    {
        public override void Up()
        {
            ...
            RenameIndex(table: "dbo.Employees", name: "IX_TeamMemberPhoto_Id", newName: "IX_TeamMemberPhotoId");
        }
        
        public override void Down()
        {
            RenameIndex(table: "dbo.Employees", name: "IX_TeamMemberPhotoId", newName: "IX_TeamMemberPhoto_Id");
